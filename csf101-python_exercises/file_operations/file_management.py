...
print(f"'sample.txt' exists: {file_exists('smaple.txt')}")
print(f"'nonexistent.txt' exists: {file_exists('noneexistent.txt')}")
...
def create_directory(directory_name):
    if not os.path.exists(directory_name):
        ...
        print(f"Drectory '{directory_name}' already exists.")
...
def copy_file(source, destination):
    ...
    print(f"File copied form {source} to {destination}")
